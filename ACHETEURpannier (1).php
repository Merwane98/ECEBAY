...
<?php
              ...
              <tr>
              <td>
                     <a href="Formulaire_Achat.html?mail=<?php echo $ligne['Acheteur']?>"><img class="logodroite" src="passercommande.jpg" height="40" width= "200"></a>
              </td>
              </tr>
              <?php
              ...
              <div id="articlegauche">
                     ...
                     <img src="<?php echo $ligne['URLimage']?>"height="200" width= "200"><br><br>
                            ...
                            <tr>
                                   ...
                                   <td><u>Vendeur</u> : <?php echo $ligne['Vendeur']?></td>
                            </tr>

...
if ($erreur == "") {echo '<td><img src="titresite1.png" width="200" height="70">'; echo "<p><b>Votre annonce concernant le ".$Type." ".$Titre." est en ligne.<br>Bonne vente !</b></p>";echo '<td><a href="pagevendeur.php"><img src="retour.png" width="150" height="150" border="10"> </a></td>';} 
else {
   echo "Erreur : $erreur";
}
...
$sql = "INSERT INTO Article VALUES (0,'$Type','$Mode1','$Mode2','$Mode3','$Titre', '$Description', '$Quantite', '$Prix','$image', '$Vendeur',0,'Aucune offre')";

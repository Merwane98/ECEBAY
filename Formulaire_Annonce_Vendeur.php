<?php
 ...
 $erreur = "";
    ...
    if ($erreur == "") {echo '<td><img src="titresite.png" width="400" height="70">'; echo "<p><b>Votre annonce concernant le ".$Type." ".$Titre." est en ligne.<br>Bonne vente !</b></p>";echo '<td><a href="pagevendeur.php"><img src="retour.png" width="150" height="150" border="10"> </a></td>';} 
 else {
 echo "Erreur : $erreur";
 }

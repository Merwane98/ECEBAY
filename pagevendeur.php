...
$mysqli = new mysqli('localhost', 'root', '', 'ecebay');
$mysqli->set_charset("utf8");
$requete1 = "SELECT ID,IDacheteur,Proposition FROM Moffre WHERE IDvendeur = '$mail' ";
       ...
       <div id="bandearticle">
              ...
              <tr>
                    <td><h2>PROPOSITION "MEILLEURE OFFRE"</h2></td>
                     <td><h2>ID annonce : <?php echo $ligne['ID']?></h2><br></td>
                     <td><b>Prix : <?php echo $ligne['Proposition']?> €</b><br></td>
                     <td><u>Acheteur</u> : <?php echo $ligne['IDacheteur']?><br></td>
                     <td><a href="Formulaire_Confirmation.html">Accepter<br></a></td>
                     <td><a href="proposition_vendeur.html">Proposer une autre offre<br></a></td>
              </tr>

...
$requete2 = "SELECT Mode2 FROM panier WHERE ID=".$IDannonce;
...
while ($ligne = $resultat->fetch_assoc()) { 
 ...
 $erreur = "";
    ...
    if($Mode2 == "") {$erreur .= "<p><b>Cette offre ne permet pas l'option achat direct.</b><br></p>";}
    ...
    if ($erreur == "") 
    {
        ...
        <div id="bandearticle">
            ...
            <tr>
                   ...
                   <td>Quantité : <?php echo $ligne['Quantité']?><br></td>
        ...
        $sql = "DELETE FROM panier WHERE Acheteur = '$mail' AND ID=".$IDannonce;
        ...
        <tr>
              <td>
                    <big><big><u>Total commande</u> : <?php echo $somme?> €</big></big> 
              </td>
              </tr>
        <?php
        $mysqli->close();

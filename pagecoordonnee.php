...
<body>
       <div id="header">
               ...
               <a href="PageAccueil.php"><img class="logodroite" src="logodeconnexion1.png" alt="logosite" width="70" height="70"></a>
               <a href="ACHETEURPageAccueil.php"><img class="logodroite" src="retour.png" alt="retour" width="70" height="70"></a>
       </div>
...
<ul id="menuderoulantdroit">
       ...
       <li><a href="#">CONTACT</a>
              <ul><li><a href="ACHETEURaproposdenous.php">A propos de nous</a></li>
...
<?php
       ...
       { ?>
              ...
              <tr>
                                   ...
                                   <td><u>Informations de Paiement</u> : <?php echo $ligne['Paiement']?><br><br></td>

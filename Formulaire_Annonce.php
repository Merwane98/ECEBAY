...
if ($erreur == "") {
    echo '<td><img src="titresite1.png" width="200" height="70">'; echo "<p><b>Votre annonce concernant le/la ".$Type." ".$Titre." est en ligne.<br>Bonne vente !</b></p>";echo '<td><a href="ECE_AMAZON.html"><img src="retour.png" width="150" height="150" border="10"> </a></td>';

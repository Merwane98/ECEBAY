<?php
 ...
 $erreur = "";
    ...
    if ($erreur == "") {echo '<td><img src="titresite1.png" width="200" height="70">'; echo "<p><b>Bienvenue ".$prenom.", votre compte vendeur vient d'être créé !<br>En vous souhaitant de bonnes ventes !<br>Veuillez-vous reconnecter.</b></p>";echo '<td><a href="PageAccueil.php"><img src="retour.png" width="150" height="150" border="10"> </a></td>';}
 else {
 echo "Erreur : $erreur";
 }

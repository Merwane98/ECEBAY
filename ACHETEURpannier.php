...
<?php
              ...
              <div id="articlegauche">
                     ...
                     <img src="<?php echo $ligne['URLimage']?>"height="200" width= "200"><br><br>
                            ...
                            <tr>
                                   ...
                                   <td>Quantité : <a href="moins.php?id=<?php echo $ligne['ID']?>"><img src="moins.png" alt="retour" width="25" height="25"></a>  <big><?php echo $ligne['Quantité']?></big>  <a href="plus.php?id=<?php echo $ligne['ID']?>"><img src="plus.png" alt="retour" width="25" height="25"></a><br><br></td>
       ...
       <div id="bande">
              ...
              <tr>
              <td>
                     <big><big><u>Total panier</u> : <?php echo $somme?> €</big></big><a href="Formulaire_Achat.html?mail=<?php echo $ligne['Acheteur']?>"><img class="logodroite" src="passercommande.jpg" height="40" width= "200"></a>
              </td>
              </tr>
              <?php      
              $mysqli->close();

...
<div id="bandeacceuil">
       ...
       <h1>CATEGORIES</h1>
      <a href="Pageferaille.php"><img class="logocentre" src="musee.jpg" alt="logosite" width="150" height="150"></a>
       <a href="Pagemusee.php"><img class="logocentre" src="tresor.jpg" alt="logosite" width="150" height="150"></a>
       <a href="Pagevip.php"><img class="logocentre" src="vip.jpg" alt="logosite" width="150" height="150"></a>
       </div>
       </div>
<div id="bandemeteo">

...
<div class="float">
       ...
       <li><a href="#">CATEGORIES</a>
              <ul>
                     <li><a href="ACHETEURPageLivre.php">Féraille ou Trésor</a></li>
                     <li><a href="ACHETEURpagemusique.php">Bon pour le Musée</a></li>
                     <li><a href="ACHETEURpagevetement.php">Accessoire VIP</a></li>
              </ul>
       </li>
